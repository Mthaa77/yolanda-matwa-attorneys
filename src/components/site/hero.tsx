          ...
          <motion.div variants={container} initial="hidden" animate="show" className="max-w-3xl">
            ...
            <motion.div variants={item} className="relative">
              ...
              <h1 className="font-display text-[clamp(2.8rem,6.4vw,5.9rem)] font-bold leading-[0.98] tracking-[-0.035em] text-cream text-balance">
                Counsel for the moments that <span className="italic text-gradient-gold">shape your future.</span>
              </h1>
            </motion.div>

            <motion.p variants={item} className="mt-8 max-w-2xl text-base leading-relaxed text-cream/76 sm:text-lg lg:text-[1.08rem]">
              A boutique legal practice for property transfers, family contracts, estates, and commercial matters — delivered with clear communication, exacting care, and the confidence of experienced counsel.
            </motion.p>
            ...
            <div className="relative overflow-hidden rounded-[1.65rem] border border-gold/30 bg-navy-deep/54 p-5 shadow-[0_28px_70px_-28px_rgba(0,0,0,0.72)] backdrop-blur-lg xl:p-6">
              ...
              <div className="relative">
                <div className="flex items-start justify-between">
                  ...
                  <span className="rounded-full border border-cream/15 bg-cream/5 px-2.5 py-1 text-[0.58rem] font-bold uppercase tracking-[0.16em] text-cream/65">Established counsel</span>
                </div>
                <p className="mt-8 font-display text-2xl font-bold leading-tight text-cream">Legal guidance, made personal.</p>
                <p className="mt-3 text-sm leading-relaxed text-cream/64">Structured advice, transparent fees, and a steady hand from your first enquiry through to completion.</p>
