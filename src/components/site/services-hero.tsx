...
export function ServicesHero() {
  ...
  return (
    <section className="relative isolate overflow-hidden bg-[#0c1830] py-16 text-cream sm:py-24 lg:py-28">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-10 px-5 sm:px-8 lg:grid-cols-[minmax(0,0.88fr)_minmax(0,1.12fr)] lg:items-center lg:gap-16 lg:px-12">
        <div className="min-w-0">
          ...
          <h2 className="mt-6 max-w-2xl break-words font-display text-[clamp(2.2rem,9vw,3.75rem)] font-bold leading-[1.03] tracking-[-0.03em] text-cream">
          ...
          <div className="mt-8 grid gap-3 sm:grid-cols-2">
            {[
              ...
              <div key={point} className="flex min-w-0 items-center gap-3 rounded-xl border border-white/10 bg-white/[0.055] px-4 py-3 text-sm leading-snug text-cream/80 shadow-[0_14px_30px_-24px_rgba(0,0,0,0.75)]">
        ...
        <figure className="relative min-w-0 overflow-hidden rounded-[1.6rem] border border-gold/30 bg-[#09101d] p-2.5 shadow-[0_38px_84px_-44px_rgba(0,0,0,0.92)] sm:rounded-[1.85rem] sm:p-3">
          ...
          <div className="relative overflow-hidden rounded-[1.05rem] bg-black sm:rounded-[1.25rem]">
            <img
          ...
          <figcaption className="relative flex min-w-0 flex-col items-start gap-3 px-2 pb-1 pt-5 sm:flex-row sm:items-center sm:gap-4 sm:px-4 sm:pt-6">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-1 max-w-2xl break-words font-display text-lg font-semibold leading-snug text-cream sm:text-xl">
                A considered practice for important South African legal matters.
              </p>
            </div>
            <Sparkles className="hidden h-5 w-5 shrink-0 text-gold/70 sm:block" />
          </figcaption>
        </figure>
      </div>
    </section>
